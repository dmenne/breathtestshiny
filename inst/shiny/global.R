...
pop_content = c(
  data_only = "<code>No fit, data only</code> Select this when you add new data or when you change data in the editor. With one of the other options, any edit will trigger lengthy calculations.",
  ...
  cross_over = "When there are multiple records for one patient such as in cross-over studies, the second column must be <code>group</code> to label the treatment. Group labels must not contain spaces.")
