...
- Code for the [Shiny web app](https://shiny.rstudio.com/) is only on [github](https://github.com/dmenne/breathteststan). 
...
- For easy installation, use the Docker container on  [Docker hub](https://hub.docker.com/r/dmenne/breathtestshiny).
